    ...
    <div className="site">
      ...
      <main id="home">
        <section className="hero">
          <img className="hero-image" src="https://api.getlayers.ai/storage/v1/object/public/public/assets/lumora-e8b711fc68/hero/after.jpg" alt="Editorial portrait" />
