...
const projects = [
  { year: '2025', type: 'Branding', name: 'Aster Labs', description: 'A complete identity and go-to-market system for a fast-moving research startup.', tags: ['Branding', 'Strategy', 'Design'], image: '/manus-storage/lumora-work-aster_3056238c.jpg' },
  { year: '2024', type: 'Product', name: 'Nova Finance', description: 'A finance platform reimagined — clear data, calm interfaces, and effortless flows.', tags: ['Product Design', 'Web App', 'QA'], image: '/manus-storage/lumora-work-nova_a608fc9d.jpg' },
  { year: '2023', type: 'Identity', name: 'Helio Studio', description: 'A bold visual identity and art direction system built to scale across every surface.', tags: ['Brand Identity', 'Art Direction'], image: '/manus-storage/lumora-work-pulse_bea3b703.jpg' },
  { year: '2023', type: 'Mobile', name: 'Pulse Health', description: 'A wellness app grounded in research, shipped end to end from concept to release.', tags: ['Mobile App', 'UX Research', 'Development'], image: '/manus-storage/lumora-work-aster_3056238c.jpg' },
];
  ...
  return (
    <div className="site">
      ...
      <main id="home">
        ...
        <section className="about lumora-shell" id="studio"><div className="about-art"><span>◎</span><div className="section-label">The Studio</div><p>A distributed team<br />building across<br />every time zone.</p></div><div className="about-copy"><h2>We partner with ambitious teams to ship <em>digital products, brand systems, and the strategy that holds them together.</em></h2><div className="about-bottom"><div><small>Find us online</small><div className="socials"><a className="social-x" href="#x">𝕏</a><a href="#behance">Bē</a><a href="#dribbble">◉</a></div></div><button className="text-link" onClick={() => go('about')}>About Us <ArrowUpRight size={15} /></button></div></div></section>
      ...
      <footer className="footer"><div className="lumora-shell footer-grid"><div><Brand dark /><p>An independent studio crafting brands, products, and the systems that connect them.</p><div className="footer-contact"><a href="mailto:Rintuchowdory@yahoo.com">Rintuchowdory@yahoo.com</a><a href="tel:017666621563">017666621563</a><a href="https://wa.me/4917666621563" target="_blank" rel="noreferrer">WhatsApp direct message</a><a href="https://rintu-portfolio.vercel.app/" target="_blank" rel="noreferrer">Personal portfolio ↗</a></div></div><div><h4>Company</h4><a href="#about">About</a><a href="#careers">Careers</a><a href="#partners">Partners</a><button onClick={() => setContactOpen(true)}>Contact</button></div><div><h4>Services</h4><a href="#development">Development</a><a href="#design">Design</a><a href="#qa">Quality Assurance</a><a href="#consulting">Consulting</a></div><div><h4>Social</h4><a href="#x">X / Twitter</a><a href="#behance">Behance</a><a href="#dribbble">Dribbble</a><a href="#linkedin">LinkedIn</a></div></div><div className="lumora-shell footer-bottom"><span>© 2025 Lumora Studio. All rights reserved.</span><span><a href="#privacy">Privacy</a><a href="#terms">Terms</a></span></div></footer>
      ...
      {contactOpen && <div className="overlay contact-overlay"><div className="overlay-top"><Brand dark /><button onClick={() => { setContactOpen(false); setSubmitted(false); }} aria-label="Close contact"><X size={20} /> Close</button></div><div className="contact-form-wrap"><div className="section-label">Start a project</div><h2>Tell us what<br />you're building.</h2>{submitted ? <div className="success"><span>✦</span><h3>Request received.</h3><p>We’ll be in touch within one business day.</p><button className="text-link" onClick={() => { setContactOpen(false); setSubmitted(false); }}>Back to site <ArrowUpRight size={15} /></button></div> : <form onSubmit={submit}><label>Name<input required name="name" placeholder="Your name" /></label><label>Email<input required type="email" name="email" placeholder="you@company.com" /></label><label>Project<textarea required name="project" rows={4} placeholder="A little about what you're building..." /></label><div className="form-foot"><small>We reply within one business day.<br /><a className="contact-inline" href="mailto:Rintuchowdory@yahoo.com">Rintuchowdory@yahoo.com</a><br /><a className="contact-inline" href="tel:017666621563">017666621563</a><br /><a className="contact-inline" href="https://wa.me/4917666621563" target="_blank" rel="noreferrer">WhatsApp me</a><br /><a className="contact-inline" href="https://rintu-portfolio.vercel.app/" target="_blank" rel="noreferrer">View personal portfolio</a></small><button className="pill-button dark" type="submit">Send request <span><ArrowUpRight size={14} /></span></button></div></form>}</div></div>}
    </div>
  );
}
